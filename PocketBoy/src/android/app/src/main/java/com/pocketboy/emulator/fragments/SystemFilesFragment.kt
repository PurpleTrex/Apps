...
import com.pocketboy.emulator.databinding.FragmentSystemFilesBinding
...
class SystemFilesFragment : Fragment() {
    ...
    private fun reloadUi() {
        val preferences = PreferenceManager.getDefaultSharedPreferences(PocketBoyApplication.appContext)
