...
package com.pocketboy.emulator.features.settings.utils
...
import com.pocketboy.emulator.features.settings.model.SettingSection
import com.pocketboy.emulator.features.settings.model.Settings.SettingsSectionMap
import com.pocketboy.emulator.features.settings.model.StringSetting
import com.pocketboy.emulator.features.settings.ui.SettingsActivityView
import com.pocketboy.emulator.utils.BiMap
import com.pocketboy.emulator.utils.DirectoryInitialization.userDirectory
...
object SettingsFile {
    ...
    fun readFile(
        ...
        try {
            val context: Context = PocketBoyApplication.appContext
    ...
    fun getSettingsFile(fileName: String): DocumentFile {
        val root = DocumentFile.fromTreeUri(PocketBoyApplication.appContext, Uri.parse(userDirectory))
