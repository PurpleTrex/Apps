...
import com.pocketboy.emulator.adapters.HomeSettingAdapter
import com.pocketboy.emulator.databinding.DialogSoftwareKeyboardBinding
import com.pocketboy.emulator.databinding.FragmentHomeSettingsBinding
...
import com.pocketboy.emulator.model.HomeSetting
...
import com.pocketboy.emulator.utils.GpuDriverHelper
import com.pocketboy.emulator.utils.Log
import com.pocketboy.emulator.viewmodel.DriverViewModel
...
class HomeSettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val optionsList = listOf(
            ...
            HomeSetting(
                R.string.select_pocketboy_user_folder,
                R.string.select_pocketboy_user_folder_home_description,
                R.drawable.ic_home,
                { mainActivity?.openPocketBoyDirectory?.launch(null) },
    ...
    private fun shareLog() {
        val logDirectory = DocumentFile.fromTreeUri(
            requireContext(),
            PermissionsHandler.pocketboyDirectory
        )?.findFile("log")
        val currentLog = logDirectory?.findFile("pocketboy_log.txt")
        val oldLog = logDirectory?.findFile("pocketboy_log.old.txt")
