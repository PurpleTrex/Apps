...
import com.pocketboy.emulator.features.hotkeys.Hotkey
...
class InputBindingSetting(
    ...
    private val context: Context get() = PocketBoyApplication.appContext
    ...
    /**
     * Returns the PocketBoy button code for the settings key.
     */
    ...
    companion object {
        ...
        /**
         * Returns the settings key for the specified PocketBoy button code.
         */
