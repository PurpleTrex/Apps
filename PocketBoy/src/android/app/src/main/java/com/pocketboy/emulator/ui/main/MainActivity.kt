...
import com.pocketboy.emulator.contracts.OpenFileResultContract
import com.pocketboy.emulator.databinding.ActivityMainBinding
...
import com.pocketboy.emulator.fragments.SelectUserDirectoryDialogFragment
import com.pocketboy.emulator.fragments.UpdateUserDirectoryDialogFragment
import com.pocketboy.emulator.utils.CiaInstallWorker
import com.pocketboy.emulator.utils.PocketBoyDirectoryHelper
import com.pocketboy.emulator.utils.PocketBoyDirectoryUtils
import com.pocketboy.emulator.utils.DirectoryInitialization
import com.pocketboy.emulator.utils.FileBrowserHelper
import com.pocketboy.emulator.utils.InsetsHelper
...
class MainActivity : AppCompatActivity(), ThemeProvider {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        PocketBoyDirectoryUtils.attemptAutomaticUpdateDirectory()
        splashScreen.setKeepOnScreenCondition {
            !DirectoryInitialization.arePocketBoyDirectoriesReady() &&
                    PermissionsHandler.hasWriteAccess(this) &&
                    !PocketBoyDirectoryUtils.needToUpdateManually()
        }
    ...
    private fun checkUserPermissions() {
        ...
        } else if (!firstTimeSetup && !homeViewModel.isPickingUserDir.value && PocketBoyDirectoryUtils.needToUpdateManually()) {
    ...
    private fun createOpenPocketBoyDirectoryLauncher(
        ...
        return registerForActivityResult(ActivityResultContracts.OpenDocumentTree()) { result: Uri? ->
            ...
            PocketBoyDirectoryHelper(this@MainActivity, permissionsLost)
                .showPocketBoyDirectoryDialog(result, buttonState = {})
        }
    }

    val openPocketBoyDirectory = createOpenPocketBoyDirectoryLauncher(permissionsLost = false)
    val openPocketBoyDirectoryLostPermission = createOpenPocketBoyDirectoryLauncher(permissionsLost = true)
