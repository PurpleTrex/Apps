...
import com.pocketboy.emulator.model.CheapDocument
...
object FileUtil {
    ...
    fun DocumentFile.inputStream(): InputStream =
        PocketBoyApplication.appContext.contentResolver.openInputStream(uri)!!

    fun DocumentFile.outputStream(): OutputStream =
        PocketBoyApplication.appContext.contentResolver.openOutputStream(uri)!!

    fun Uri.inputStream(): InputStream =
        PocketBoyApplication.appContext.contentResolver.openInputStream(this)!!

    fun Uri.outputStream(): OutputStream =
        PocketBoyApplication.appContext.contentResolver.openOutputStream(this)!!

    fun Uri.asDocumentFile(): DocumentFile? =
        DocumentFile.fromSingleUri(PocketBoyApplication.appContext, this)
