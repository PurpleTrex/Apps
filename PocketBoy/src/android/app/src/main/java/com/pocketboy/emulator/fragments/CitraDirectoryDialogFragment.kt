...
import com.pocketboy.emulator.databinding.DialogPocketBoyDirectoryBinding
...
class PocketBoyDirectoryDialogFragment : DialogFragment() {
    private lateinit var binding: DialogPocketBoyDirectoryBinding
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        binding = DialogPocketBoyDirectoryBinding.inflate(layoutInflater)
        ...
        val oldPath = PermissionsHandler.pocketboyDirectory
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setNegativeButton(android.R.string.cancel) { _: DialogInterface?, _: Int ->
                if (!PermissionsHandler.hasWriteAccess(requireContext())) {
                    (requireActivity() as MainActivity)?.openPocketBoyDirectory?.launch(null)
                }
            }
            .show()
    }
    ...
    companion object {
        const val TAG = "pocketboy_directory_dialog_fragment"
        ...
        fun newInstance(
            ...
            path: String,
            listener: Listener
        ): PocketBoyDirectoryDialogFragment {
            val dialog = PocketBoyDirectoryDialogFragment()
