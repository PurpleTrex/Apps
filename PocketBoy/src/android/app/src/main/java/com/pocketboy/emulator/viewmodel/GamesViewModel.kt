...
class GamesViewModel : ViewModel() {
    ...
    init {
        ...
        val storedGames = PreferenceManager.getDefaultSharedPreferences(PocketBoyApplication.appContext)
        ...
        if (storedGames!!.isNotEmpty()) {
            ...
            storedGames.forEach {
                ...
                val gameExists =
                    DocumentFile.fromSingleUri(PocketBoyApplication.appContext, Uri.parse(game.path))
                        ?.exists()
                if (gameExists == true) {
