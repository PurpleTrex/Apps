...
import com.pocketboy.emulator.NativeLibrary.InstallStatus
import com.pocketboy.emulator.R
import com.pocketboy.emulator.utils.FileUtil.getFilename

class CiaInstallWorker(
    val context: Context,
    params: WorkerParameters
) : Worker(context, params) {
    private val GROUP_KEY_CIA_INSTALL_STATUS = "com.pocketboy.emulator.CIA_INSTALL_STATUS"
