...
import com.pocketboy.emulator.databinding.DialogCopyDirBinding
                    ...
                    homeViewModel.copyComplete.collect {
                        if (it) {
                            homeViewModel.setUserDir(
                                requireActivity(),
                                PermissionsHandler.pocketboyDirectory.path!!
                            )
                        ...
                        object : FileUtil.CopyDirListener {
                            override fun onSearchProgress(directoryName: String) {
                                viewModel.onUpdateSearchProgress(
                                    PocketBoyApplication.appContext.resources,
                                    directoryName
                                )
                            }
                            ...
                            override fun onComplete() {
                                PocketBoyDirectoryHelper.initializePocketBoyDirectory(path)
