...
import com.pocketboy.emulator.ui.main.ThemeProvider
...
object ThemeUtil {
    ...
    private fun getSelectedStaticThemeColor(): Int {
        ...
        val themes = arrayOf(
            R.style.Theme_PocketBoy_Blue,
            R.style.Theme_PocketBoy_Cyan,
            R.style.Theme_PocketBoy_Red,
            R.style.Theme_PocketBoy_Green,
            R.style.Theme_PocketBoy_Yellow,
            R.style.Theme_PocketBoy_Orange,
            R.style.Theme_PocketBoy_Violet,
            R.style.Theme_PocketBoy_Pink,
            R.style.Theme_PocketBoy_Gray
        )
    ...
    fun setTheme(activity: AppCompatActivity) {
        ...
        if (preferences.getBoolean(Settings.PREF_MATERIAL_YOU, false)) {
            activity.setTheme(R.style.Theme_PocketBoy_Main_MaterialYou)
        } else {
        ...
        if (preferences.getBoolean(Settings.PREF_BLACK_BACKGROUNDS, false) &&
            ...
            activity.setTheme(R.style.ThemeOverlay_PocketBoy_Dark)
        }
    }
