...
import com.pocketboy.emulator.EmulationNavigationDirections
...
import com.pocketboy.emulator.databinding.DialogCheckboxBinding
import com.pocketboy.emulator.databinding.DialogSliderBinding
import com.pocketboy.emulator.databinding.FragmentEmulationBinding
import com.pocketboy.emulator.display.PortraitScreenLayout
import com.pocketboy.emulator.display.ScreenAdjustmentUtil
import com.pocketboy.emulator.display.ScreenLayout
...
import com.pocketboy.emulator.utils.DirectoryInitialization.DirectoryInitializationState
...
import com.pocketboy.emulator.utils.EmulationLifecycleUtil
import com.pocketboy.emulator.utils.Log
import com.pocketboy.emulator.utils.ViewUtils
import com.pocketboy.emulator.viewmodel.EmulationViewModel

class EmulationFragment : Fragment(), SurfaceHolder.Callback, Choreographer.FrameCallback {
    private val preferences: SharedPreferences
        get() = PreferenceManager.getDefaultSharedPreferences(PocketBoyApplication.appContext)
    ...
    override fun onResume() {
        ...
        if (DirectoryInitialization.arePocketBoyDirectoriesReady()) {
            ...
            setupPocketBoyDirectoriesThenStartEmulation()
        }
    }
    ...
    private fun setupPocketBoyDirectoriesThenStartEmulation() {
            ...
            perfStatsUpdater = Runnable {
                ...
                if (perfStats[FPS] > 0) {
                    ...
                    if (BooleanSetting.PERF_OVERLAY_BACKGROUND.boolean) {
                        binding.performanceOverlayShowText.setBackgroundResource(R.color.pocketboy_transparent_black)
                    } else {
