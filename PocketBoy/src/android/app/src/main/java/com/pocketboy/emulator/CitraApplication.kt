...
import com.pocketboy.emulator.utils.DocumentsTree
...
import com.pocketboy.emulator.utils.MemoryUtil

class PocketBoyApplication : Application() {
    ...
    companion object {
        private var application: PocketBoyApplication? = null
