...
import com.pocketboy.emulator.adapters.SetupAdapter
import com.pocketboy.emulator.databinding.FragmentSetupBinding
import com.pocketboy.emulator.features.settings.model.Settings
import com.pocketboy.emulator.model.ButtonState
import com.pocketboy.emulator.model.PageButton
import com.pocketboy.emulator.model.PageState
import com.pocketboy.emulator.model.SetupCallback
import com.pocketboy.emulator.model.SetupPage
...
class SetupFragment : Fragment() {
                    ...
                    pageButtons = mutableListOf<PageButton>().apply {
                        add(
                            PageButton(
                                ...
                                R.string.select_pocketboy_user_folder_description,
                                buttonAction = {
                                    pageButtonCallback = it
                                    openPocketBoyDirectory.launch(null)
                                },
                                buttonState = {
    ...
    private val openPocketBoyDirectory = registerForActivityResult<Uri, Uri>(
        ...
        PocketBoyDirectoryHelper(requireActivity(), true).showPocketBoyDirectoryDialog(result, pageButtonCallback, checkForButtonState)
    }
