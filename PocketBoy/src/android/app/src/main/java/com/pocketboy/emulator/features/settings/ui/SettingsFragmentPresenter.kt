...
import com.pocketboy.emulator.features.settings.model.IntSetting
...
import com.pocketboy.emulator.features.settings.model.StringSetting
import com.pocketboy.emulator.features.settings.model.view.DateTimeSetting
import com.pocketboy.emulator.features.settings.model.view.HeaderSetting
...
import com.pocketboy.emulator.features.settings.utils.SettingsFile
import com.pocketboy.emulator.fragments.ResetSettingsDialogFragment
import com.pocketboy.emulator.utils.BirthdayMonth
...
import com.pocketboy.emulator.utils.EmulationMenuSettings
...
class SettingsFragmentPresenter(private val fragmentView: SettingsFragmentView) {
    ...
    fun onViewCreated(settingsAdapter: SettingsAdapter) {
        ...
        preferences = PreferenceManager.getDefaultSharedPreferences(PocketBoyApplication.appContext)
        loadSettingsList()
    }
    ...
    private fun addSystemSettings(sl: ArrayList<SettingsItem>) {
        ...
        sl.apply {
            val usernameSetting = object : AbstractStringSetting {
                ...
                override val defaultValue = "POCKETBOY"
            }
