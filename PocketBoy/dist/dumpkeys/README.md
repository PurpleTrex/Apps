...
This is a GodMode9 script that dumps all the keys and other related secrets that PocketBoy needs from a real 3DS.
...
4. Power off your system and copy the "gm9/aes_keys.txt" and "gm9/seeddb.bin" files off of your SD card into "(PocketBoy directory)/sysdata/".
